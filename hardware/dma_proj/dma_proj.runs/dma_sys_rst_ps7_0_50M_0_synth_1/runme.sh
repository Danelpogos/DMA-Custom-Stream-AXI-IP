...
HD_PWD='/home/danny/class/labs/lab8/hardware/dma_proj/dma_proj.runs/dma_sys_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_sys_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_sys_rst_ps7_0_50M_0.tcl
