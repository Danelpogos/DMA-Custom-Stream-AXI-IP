...
HD_PWD='/home/danny/class/labs/lab8/hardware/dma_proj/dma_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_sys_wrapper.tcl -notrace
